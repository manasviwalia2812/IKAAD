...
export default function LogoutButton({ onLogoutSuccess }) {
    ...
    const [classes, setClasses] = useState('logoutButton');
    ...
    const handleClick = () => {
        if (state === 'default' || state === 'hover') {
            setClasses('logoutButton clicked');
            setState('walking1');
            
            setTimeout(() => {
                setClasses('logoutButton clicked door-slammed');
                setState('walking2');
                
                setTimeout(() => {
                    setClasses('logoutButton clicked door-slammed falling');
                    setState('falling1');
